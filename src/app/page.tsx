  ...
  return (
    <div className="min-h-screen bg-surface-muted">
      ...
      <footer className="border-t border-border bg-surface">
        <div className="mx-auto flex min-h-20 w-full max-w-container flex-col justify-center gap-1 px-5 py-5 text-sm text-text-secondary sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-10">
          <div>
